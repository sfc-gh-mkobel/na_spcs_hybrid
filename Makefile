...
IMAGE_REGISTREY_HOSTNAME?=sfseeurope-sfseeurope-eu-demo376.registry.snowflakecomputing.com
SS_DB=SPCS_APP
SS_SCHEMA=NAPP
SS_STAGE=APP_STAGE
ROLE=naspcs_role
...
snow_create:
	snow app version create V1 --role naspcs_role

snow_validate:
	snow app validate --role naspcs_role

snow_app_run:
	snow app run --version v1 --role naspcs_role
